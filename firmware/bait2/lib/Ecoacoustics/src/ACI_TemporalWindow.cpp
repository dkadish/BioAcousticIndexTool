...
ACI_TemporalWindow::ACI_TemporalWindow(int interval, FFTReader &fft, bool doFilter, bool doDiscardAdjacentZeros, int debugInterval) : Sensor(interval, debugInterval), _fft(fft), _filter_fft(doFilter), _discard_adjacent_zeros(doDiscardAdjacentZeros) {}
...
void ACI_TemporalWindow::process()
{
    ...
    // TODO this caused a compilation error. What's up here?
    //     if(Sensor::getPrint()) {
    //         Serial.print("ACI TW: ");
